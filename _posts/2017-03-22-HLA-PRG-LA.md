...
![An example PRG with 3 haplotypes.](/downloads/HLPRGLA_Figure_PRG.png "An example PRG with 3 haplotypes."){: .center-image }
...
![MSA and PRG](/downloads/HLPRGLA_MSAandPRG.png "A multiple sequence alignment and the corresponding fully recombining PRG"){: .center-image }

To align a read pair, we go through the following steps (see below for descriptions of the steps):

![Graph alignment by linear approximation](/downloads/HLPRGLA_FullInferenceProcess.png "Graph alignment by linear approximation"){: .center-image }
...
![Accuracy comparison](/downloads/HLAPRGLA_performance.png "Accuracy HLA\*PRG and HLA\*PRG:LA"){: .center-image }
