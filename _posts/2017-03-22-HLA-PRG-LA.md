...
<div style="text-align:center">![An example PRG with 3 haplotypes.](/downloads/HLPRGLA_Figure_PRG.png "An example PRG with 3 haplotypes.")</div>
...
<div style="text-align:center">![MSA and PRG](/downloads/HLPRGLA_MSAandPRG.png "A multiple sequence alignment and the corresponding fully recombining PRG")</div>

To align a read pair, we go through the following steps (see below for descriptions of the steps):

<div style="text-align:center">![Graph alignment by linear approximation](/downloads/HLPRGLA_FullInferenceProcess.png "Graph alignment by linear approximation")</div>
...
<div style="text-align:center">![Accuracy comparison](/downloads/HLAPRGLA_performance.png "Accuracy HLA\*PRG and HLA\*PRG:LA")</div>

Inferring HLA types for the 2 x 100bp NA12878 sample tool 32 CPU hours and 30G of memory; for the 2 x 250bp NA12878 sample, 31 CPU hours and 33G of memory.
