...
![An example PRG with 3 haplotypes.](/download/HLPRGLA_Figure_PRG.png "An example PRG with 3 haplotypes.")
...
![MSA and PRG](/download/HLPRGLA_MSAandPRG.png "A multiple sequence alignment and the corresponding fully recombining PRG")

To align a read pair, we go through the following steps (see below for descriptions of the steps):

![Graph alignment by linear approximation](/download/HLPRGLA_FullInferenceProcess.png "Graph alignment by linear approximation")
...
![Accuracy comparison](/download/HLAPRGLA_performance.png "Accuracy HLA\*PRG and HLA\*PRG:LA")
